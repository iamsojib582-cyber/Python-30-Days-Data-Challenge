...
class DataAnalystStudio:
    ...
    def _build_pivot_tab(self) -> None:
        ...
        self.pivot_agg_combo = ttk.Combobox(controls, state="readonly", width=12, values=["sum", "mean", "count", "min", "max"])
    ...
    def open_file(self) -> None:
        ...
        try:
            if file_path.lower().endswith(".csv"):
                ...
                messagebox.showerror("Unsupported File", "Please open CSV, Excel, or JSON files.")
                return
